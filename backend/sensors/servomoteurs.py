...
class ServoMotors:
    def __init__(self, pca, channel, min_pulse=500, max_pulse=2400, actuation_range=180, initial_angle=90, step_size=2):
        """
...
def start_servos_control():
    ...
    pan_servo = ServoMotors(pca, channel=PAN_CHANNEL)
    tilt_servo = ServoMotors(pca, channel=TILT_CHANNEL)
    wheel_servo = ServoMotors(pca, channel=WHEEL_CHANNEL)
